...
class TabMenuViewModel {
  List<TabMenu> get items => <TabMenu>[
    TabMenu('Stock', Stock(), icon: FontAwesomeIcons.box),
    TabMenu('Chart', Chart(), icon: FontAwesomeIcons.chartArea),
    TabMenu('Report', Report(), icon: FontAwesomeIcons.fileAlt),
  ];
}